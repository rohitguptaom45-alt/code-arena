...
export const leaderboard = Array.from({
  length: 20,
}).map((_, i) => ({
  rank: i + 1,
  username: [
...
export const quizzes = [
  ...
  },
  {
    ...
    questions: [
      {
        q: 'Which array method returns a new array with transformed elements?',
        options: ['forEach()', 'map()', 'filter()', 'reduce()'],
        correct: 1,
      },
      {
        q: 'What does `[1,2,3].filter(n => n > 1)` return?',
        options: ['[1]', '[2,3]', '[1,2,3]', '[]'],
        correct: 1,
      },
      {
        q: 'Which loop is best for iterating with early exit via break?',
        options: ['forEach', 'for', 'map', 'filter'],
        correct: 1,
      },
      {
        q: 'What does `Array.isArray([])` return?',
        options: ['true', 'false', 'undefined', 'Error'],
        correct: 0,
      },
      {
        q: '`[1,2,3].reduce((a,b) => a+b, 0)` evaluates to?',
        options: ['3', '6', '[1,2,3]', 'undefined'],
        correct: 1,
      },
    ],
  },
  ...
  },
  {
    ...
    questions: [
      {
        q: 'What is the time complexity of dict lookups on average?',
        options: ['O(n)', 'O(log n)', 'O(1)', 'O(n^2)'],
        correct: 2,
      },
      {
        q: 'Which structure would you use for FIFO behaviour?',
        options: ['list.append/pop', 'collections.deque', 'set', 'tuple'],
        correct: 1,
      },
      {
        q: 'What does a list comprehension `[x*x for x in range(5) if x % 2 == 0]` produce?',
        options: ['[0,4,16]', '[0,1,4,9,16]', '[1,9]', '[0,2,4]'],
        correct: 0,
      },
      {
        q: 'Which module gives you `Counter` and `defaultdict`?',
        options: ['itertools', 'functools', 'collections', 'heapq'],
        correct: 2,
      },
      {
        q: 'What does `heapq.heappush` maintain?',
        options: ['A sorted list', 'A min-heap', 'A max-heap', 'A balanced BST'],
        correct: 1,
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Faster loops', 'Data hiding', 'Multiple inheritance', 'Memory allocation'],
        correct: 1,
      },
      {
      ...
      {
        q: 'An interface method (default Java 8+) can have a body if marked with?',
        options: ['abstract', 'default', 'static final', 'virtual'],
        correct: 1,
      },
      {
        q: 'What is method overriding an example of?',
    ...
    questions: [
      {
        ...
        options: ['Stack allocation', 'Heap allocation', 'Deletes memory', 'Nothing'],
        correct: 1,
      },
      {
        q: 'What happens if you forget to `delete` heap memory?',
        options: ['Compile error', 'Memory leak', 'Segfault always', 'Nothing, GC handles it'],
        correct: 1,
      },
      {
        q: 'What does a dangling pointer point to?',
        options: ['Valid new memory', 'Freed/invalid memory', 'A function', 'Nothing, it errors immediately'],
        correct: 1,
      },
      {
        q: 'Which smart pointer allows only one owner?',
        options: ['shared_ptr', 'unique_ptr', 'weak_ptr', 'raw_ptr'],
        correct: 1,
      },
      {
        q: 'What does `*ptr` do when `ptr` is a pointer?',
        options: ['Gets the address', 'Dereferences to the value', 'Deletes the pointer', 'Increments it'],
        correct: 1,
      },
    ],
  },
    ...
    messages: [
      {
        id: 1,
        from: 'them',
        text: 'Hey! Saw you climbed the leaderboard this week 🔥',
        time: '9:12 AM',
      },
      {
        id: 2,
        from: 'me',
        text: 'Haha thanks, that Debugging Royale round was brutal',
        time: '9:14 AM',
      },
      {
        id: 3,
        from: 'them',
        text: 'Right?? The memory leak bug in problem 4 got me for 20 mins',
        time: '9:15 AM',
      },
      {
        id: 4,
        from: 'them',
        text: 'Are you joining Weekly Marathon #42 tomorrow?',
        time: '9:15 AM',
      },
    ],
  },
    ...
    messages: [
      {
        id: 1,
        from: 'them',
        text: 'gg on the react tournament, that drag-and-drop UI was clean',
        time: 'Yesterday',
      },
      {
        id: 2,
        from: 'me',
        text: 'thank you! yours was faster though 😅',
        time: 'Yesterday',
      },
    ],
  },
    ...
    messages: [
      {
        id: 1,
        from: 'them',
        text: 'Can you review my solution for SQL Clash #7 when you get a sec?',
        time: 'Mon',
      },
      {
        id: 2,
      ...
      },
      {
        id: 3,
        from: 'them',
        text: 'Just shared it in the SQL Challenge community 🙏',
        time: 'Mon',
      },
    ],
  },
    ...
    messages: [
      {
        id: 1,
        from: 'them',
        text: 'Your editorial for the graph problem was super clear, thanks!',
        time: 'Sat',
      },
    ],
  },
    ...
    messages: [
      {
        ...
        from: 'other',
        user: 'ishaan.py',
        text: "Anyone else's editor lagging on the new Python runtime?",
        time: '8:02 AM',
      },
      {
        id: 2,
        from: 'other',
        user: 'byte_bandit',
        text: 'Working fine for me, try clearing cache in Settings',
        time: '8:05 AM',
      },
      {
        id: 3,
        from: 'other',
        user: 'rhea_builds',
        text: 'Weekly Marathon #42 starts in 6 hours, good luck everyone 🚀',
        time: '8:20 AM',
      },
    ],
  },
    ...
    messages: [
      {
        ...
        from: 'other',
        user: 'nullptr_ninja',
        text: 'Segment trees or Fenwick trees for range updates + range queries?',
        time: '10:41 AM',
      },
      {
        id: 2,
        from: 'other',
        user: 'meera_ml',
        text: 'Fenwick if you only need point updates, segment tree is more flexible',
        time: '10:44 AM',
      },
    ],
  },
    ...
    messages: [
      {
        ...
        from: 'other',
        user: 'sana_scripts',
        text: 'Season 3 judging criteria dropped, check the contest page',
        time: 'Yesterday',
      },
      {
        id: 2,
        from: 'other',
        user: 'arjun_async',
        text: 'Anyone using a state machine lib for the drag-and-drop round?',
        time: 'Yesterday',
      },
      {
        id: 3,
        from: 'other',
        user: 'diya_docker',
        text: 'Just useReducer, keeping it simple this time',
        time: 'Yesterday',
      },
    ],
  },
    ...
    messages: [
      {
        ...
        from: 'other',
        user: 'ananya_dev',
        text: 'Just shared my SQL Clash #7 solution, feedback welcome 🙏',
        time: 'Mon',
      },
      {
        id: 2,
        from: 'other',
        user: 'karthik_cpp',
        text: 'Your index choice on the join is smart, saved a full scan',
        time: 'Mon',
      },
    ],
  },
...
const communityAutoReplies = [
  {
    user: 'stackoverflow_king',
    text: 'Good discussion, following along 👀',
  },
  {
    user: 'priya_prod',
    text: 'Same question here honestly',
  },
  {
    user: 'yash_yield',
    text: 'This community is so helpful 🙌',
  },
]
